...
function btnClicking() {
    ...
    document.querySelector("#dec-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#445a72"
        document.querySelector("#enc-btn").style.backgroundColor = "#021b38"
    ...
    document.querySelector("#enc-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#021b38"
        document.querySelector("#enc-btn").style.backgroundColor = "#445a72"
